...
class ReceivedEmailsFetcher
{
    ...
    public function findOneByTemporaryEmailAddressAndReceivedEmailUuid(string $email, Uuid $receivedEmailUuid): ReceivedEmail
    {
        $emailBox = $this->temporaryEmailBoxRepository->findOneBy(['email' => $email]);
